...
// সব রিকোয়েস্ট দেখা (অ্যাডমিন এবং ভলান্টিয়ার উভয়ের জন্য)
...
const stripe = new Stripe(process.env.STRIPE_SECRET_KEY); // এটি যোগ করুন
// 💳 STRIPE PAYMENT INTENT
app.post("/create-payment-intent", async (req, res) => {
  try {
    const { amount } = req.body; 
    const paymentIntent = await stripe.paymentIntents.create({
      amount: amount * 100, // স্ট্রাইপ অ্যামাউন্ট সেন্টে নেয়
      currency: "usd",
    });
